  ...
  head: () => ({
    meta: [
      ...
      { title: "Lumen — roleplay e escrita com IA sem limites" },
      {
        name: "description",
        content:
          "Crie personagens, viva roleplays imersivos e escreva histórias longas com IA. Sem limites de tokens, sem paywall.",
      },
      { property: "og:title", content: "Lumen — roleplay e escrita com IA sem limites" },
      {
        property: "og:description",
        content: "Personagens, roleplay imersivo e escrita de histórias com IA. Tudo livre.",
      },
